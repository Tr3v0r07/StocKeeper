    ...
    @section('setupCustomer')
        ...
        <script type="text/javascript">
            var i = 0;
                ...
                $('#trim').append('<input name="order['+i+'][sn]" type="datalist" list="rolls" class="col-start-1 col-span-2 rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" id="roll'+i+'"></select>');
                $('#trim').append('<input type="text" type="datalist" list="Trim" class="col-start-3 col-span-5 rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="order['+i+'][desc]">');
                $('#trim').append('<input type="text" class="col-start-8 rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="order['+i+'][quantity]">');
                    ++i;
            };
                ...
                $('#other').append('<input type="text" type="datalist" list="Inv" class="col-start-3 col-span-5 rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="order['+i+'][desc]">');
                $('#other').append('<input type="text" class="col-start-8 rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="order['+i+'][quantity]">');
                    ++i;
            };
        ...
        <form method="POST" action={{route('quoteOrder')}}  id="orderform">
            ...
            <div class="grid grid-cols-9 gap-3">
                ...
                <label for="Customer Name" class=" col-span-5">Customer Name</label>
                <button type="submit" class="m-auto col-start-9 inline-flex float-right items-center  px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">submit</button>
                ...
                <button type="button" onclick="addTrim()" class="m-auto col-start-8 inline-flex float-right items-center  px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">Add Trim</button>
                <button type="button" onclick="addOther()" class="m-auto col-start-9 inline-flex float-right items-center  px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">Add Other</button>
            </div>

            <div id="panels" class="grid grid-cols-9 gap-3 my-3">
            <div class="border-purple-400 border-t border-b col-span-9 pr-6">Panels</div>
                 <label for="" class="col-start-1 col-span-2">Roll</label>
                 <label for="" class="col-start-3 col-span-3">Description</label>
                 <label for="" class="col-start-6 ">Length: ft</label>
                 <label for="" class="col-start-7">in</label>
                 <label for="" class="col-start-8">Quantity</label>
            <datalist id="rolls">
        ...
        <div id="trim" class="grid grid-cols-9 gap-3">
            <div class="col-span-9 border-purple-400 border-t border-b my-3 pr-6">Trim</div>
            <label for="" class="col-start-1 col-span-2">Roll</label>
            <label for="" class="col-start-3 col-span-5">Description</label>
            <label for="" class="col-start-8">Quantity</label>

        </div>
        <div id="other" class="grid grid-cols-9 gap-3">
